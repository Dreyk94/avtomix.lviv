...
-- ============================================================
-- Оновлення: функціонал "Продано". Виконайте це в SQL Editor,
-- якщо таблиця cars вже була створена раніше (до цієї версії).
-- ============================================================
alter table cars add column if not exists sold boolean not null default false;
